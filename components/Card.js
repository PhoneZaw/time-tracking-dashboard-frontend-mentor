...
const Card = ({ title, slug, timeframes, time }) => {
  return (
    <div className={`${slug} rounded-2xl w-full md:w-64 shadow-lg`}>
      {/* ^ ${slug} is used for background color */}
      <div className="h-14 flex justify-end overflow-hidden relative">
      ...
      <div className="rounded-2xl bg-secondary-300 p-7 -mb-1 hover:cursor-pointer hover:bg-secondary-200">
